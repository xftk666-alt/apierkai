...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	commerceCatalogRepository := repository.NewCommerceCatalogRepository(db)
	commerceOrderRepository := repository.NewCommerceOrderRepository(db)
	commerceFeatureService := service.NewCommerceFeatureService(settingService)
	commerceCatalogService := service.NewCommerceCatalogService(commerceCatalogRepository, groupRepository, commerceFeatureService)
	...
	commerceOrderService := service.NewCommerceOrderService(commerceOrderRepository, commerceCatalogService, userRepository, subscriptionService, billingCacheService, apiKeyAuthCacheInvalidator, client)
	...
	commerceHandler := handler.NewCommerceHandler(commerceCatalogService, commerceOrderService)
	...
	adminCommerceHandler := admin.NewCommerceHandler(commerceCatalogService, commerceOrderService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, adminCommerceHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, adminAPIKeyHandler, scheduledTestHandler)
