export default {
  ...
  admin: {
    ...
    commerce: {
      ...
      hints: {
        tags: '使用逗号或换行分隔多个标签',
        metadata: '仅支持 JSON 对象，留空可使用 {}',
        noProductsForBinding: '请先创建商品，再绑定到模型'
      },
      ordersFilterPlaceholder: '例如 CO20260319000123',
      ordersFilterHint: '可按订单号快速定位某次下单、回调或手动完单记录。',
      ordersFilterActive: '当前按订单号筛选：{orderNo}',
      orderDetailTitle: '订单详情',
      orderDetailBasicInfo: '订单信息',
      orderDetailSnapshot: '快照详情',
      orderDetailPaymentAction: '支付动作',
      orderDetailPaymentStatus: '支付状态',
      orderDetailPaidAt: '支付时间',
      orderDetailExpiredAt: '过期时间',
      orderDetailUpdatedAt: '更新时间',
      orderDetailProductCode: '商品编码',
      orderDetailPriceType: '价格类型',
      orderDetailOriginalAmount: '原价',
      orderDetailMetadata: '元数据',
      orderDetailCheckoutUrl: '跳转地址',
      orderDetailPaymentActionEmpty: '当前订单没有可用的支付动作信息。',
      orderDetailTransaction: '支付交易',
      orderDetailTransactionStatus: '交易状态',
      orderDetailProviderTradeNo: '渠道交易号',
      orderDetailPaidAmount: '支付金额',
      orderDetailRequestPayload: '请求 Payload',
      orderDetailCallbackPayload: '回调 Payload',
      orderDetailTransactionEmpty: '当前订单还没有支付交易记录。',
      statuses: {
        draft: '草稿',
        active: '启用',
        disabled: '停用'
      ...
      empty: {
        productsTitle: '还没有商品',
        productsDesc: '先创建第一个可售商品，作为原生模型广场入口。',
        modelsTitle: '还没有模型挂载',
        modelsDesc: '先创建模型挂载，再把商品绑定进去。',
        pricesDesc: '暂时没有价格行，需要时可继续添加。',
        grantsDesc: '暂时没有权益行，可在这里配置订阅或分组权限。',
        bindingsDesc: '暂时没有绑定商品，可将一个或多个商品挂到当前模型。'
      },
      messages: {
        loadFailed: '加载商业化目录失败',
        productCreated: '商品创建成功',
        productUpdated: '商品更新成功',
        modelCreated: '模型创建成功',
        modelUpdated: '模型更新成功',
        orderCompleted: '订单已完成',
        manualCompleteConfirm: '确定手动完成订单 {orderNo} 吗？'
      },
      validation: {
        productCodeRequired: '商品编码不能为空',
        productNameRequired: '商品名称不能为空',
        modelKeyRequired: '模型键不能为空',
        displayNameRequired: '显示名称不能为空',
        metadataInvalid: '元数据必须是合法 JSON',
        metadataObjectOnly: '元数据必须是 JSON 对象',
        priceTypeRequired: '第 {index} 行价格缺少价格类型',
        priceAmountRequired: '第 {index} 行价格缺少金额',
        currencyRequired: '第 {index} 行价格缺少币种',
        groupRequired: '第 {index} 行权益缺少分组',
        productRequired: '第 {index} 行绑定缺少商品'
      }
    },
    ...
    settings: {
      ...
      purchase: {
        title: '充值/订阅页面',
        description: '统一控制商业化入口，支持 iframe 模式与原生模型广场模式',
        enabled: '显示充值/订阅入口',
        enabledHint: '仅在标准模式（非简单模式）下展示',
        mode: '入口模式',
        modeHint: 'iframe 模式兼容现有外部支付页；原生模式将使用站内模型广场作为主入口',
        modeOptionsIframe: 'iframe 外链模式',
        modeOptionsNative: '原生模型广场模式',
        url: '充值/订阅页面 URL',
        urlPlaceholder: 'https://example.com/purchase',
        urlHint: '必须是完整的 http(s) 链接',
        urlHintOptional: '原生模式下该链接可作为旧版入口保留，选填',
        iframeWarning:
          '⚠️ iframe 提示：部分网站会通过 X-Frame-Options 或 CSP（frame-ancestors）禁止被 iframe 嵌入，出现空白时可引导用户使用”新窗口打开”。',
        nativeMarketplaceEnabled: '启用原生模型广场',
        nativeMarketplaceHint: '启用后，侧边栏主入口将切换到站内模型广场页面',
        nativeWalletEnabled: '启用原生钱包页',
        nativeWalletHint: '为后续余额流水和充值记录页面预留入口开关',
        nativeOrdersEnabled: '启用原生订单页',
        nativeOrdersHint: '为后续支付订单与购买记录页面预留入口开关',
        callbackSecret: '回调共享密钥',
        callbackSecretPlaceholder: '为支付回调设置共享密钥',
        callbackSecretConfiguredPlaceholder: '留空则保持当前密钥不变',
        callbackSecretHint: '用于校验公开支付回调，校验通过后才会自动完成站内商业化订单',
        callbackSecretConfiguredHint: '当前已存在回调密钥，留空可保持不变',
        callbackEndpoint: '回调地址',
        callbackEndpointHint:
          '这是与支付渠道无关的成功回调入口，请至少传 order_no；也可附带 provider_trade_no、paid_amount、paid_currency、request_payload、callback_payload',
        callbackHeader: '必填请求头',
        callbackHeaderHint: '每次回调都需要在该请求头中携带上方配置的共享密钥',
        providersTitle: '\u652f\u4ed8\u6e20\u9053\u914d\u7f6e',
        providersHint: '\u914d\u7f6e\u6bcf\u4e2a\u652f\u4ed8\u6e20\u9053\u7684\u5c55\u793a\u4fe1\u606f\u4e0e\u652f\u4ed8\u8df3\u8f6c URL \u6a21\u677f\u3002',
        providersEmpty: '\u5f53\u524d\u8fd8\u6ca1\u6709\u914d\u7f6e\u652f\u4ed8\u6e20\u9053\uff0c\u65b0\u589e\u540e\u5373\u53ef\u5728\u539f\u751f\u6a21\u578b\u5e7f\u573a\u663e\u793a\u652f\u4ed8\u6309\u94ae\u3002',
        providerCard: '\u652f\u4ed8\u6e20\u9053',
        providerAdd: '\u65b0\u589e\u6e20\u9053',
        providerRemove: '\u79fb\u9664\u6e20\u9053',
        providerCode: '\u6e20\u9053\u6807\u8bc6',
        providerCodeHint: '\u8ba2\u5355\u4e0e\u56de\u8c03\u6d41\u7a0b\u4f7f\u7528\u7684\u552f\u4e00\u6807\u8bc6',
        providerCodePlaceholder: '\u4f8b\u5982\uff1aalipay\u3001wechat_pay\u3001stripe',
        providerName: '\u6e20\u9053\u540d\u79f0',
        providerNamePlaceholder: '\u4f8b\u5982\uff1a\u652f\u4ed8\u5b9d',
        providerDescription: '\u6e20\u9053\u63cf\u8ff0',
        providerDescriptionPlaceholder: '\u5c55\u793a\u5728\u6a21\u578b\u5e7f\u573a\u7684\u7b80\u77ed\u63cf\u8ff0',
        providerIcon: '\u6e20\u9053\u56fe\u6807 URL',
        providerIconPlaceholder: 'https://example.com/icon.png',
        providerSortOrder: '\u6392\u5e8f',
        providerCheckoutUrl: '\u652f\u4ed8\u8df3\u8f6c URL \u6a21\u677f',
        providerCheckoutUrlPlaceholder: 'https://pay.example.com/checkout?order_no={order_no}',
        providerEnabled: '\u542f\u7528\u6e20\u9053',
        providerEnabledHint: '\u53ea\u6709\u542f\u7528\u7684\u6e20\u9053\u624d\u4f1a\u5728\u539f\u751f\u6a21\u578b\u5e7f\u573a\u5bf9\u7528\u6237\u663e\u793a',
        providerTemplateHint: '\u652f\u6301\u5360\u4f4d\u7b26\uff0c\u7cfb\u7edf\u4f1a\u6309\u8ba2\u5355\u52a8\u6001\u751f\u6210\u652f\u4ed8\u94fe\u63a5\u3002',
        providerTemplateVars: '\u53ef\u7528\u6a21\u677f\u53d8\u91cf',
        providerExampleTitle: '支付渠道 JSON 示例',
        providerExampleHint: '这里是 `commerce_payment_providers` 的示例 JSON，保存前请替换为你的域名、名称和模板。',
        providerExampleCopy: '复制示例 JSON',
        providerExampleCopied: '已复制支付渠道示例 JSON',
        callbackExampleTitle: '回调测试示例',
        callbackExampleHint: '建议先在测试环境使用。发送前请替换渠道路径、共享密钥和待支付订单号。',
        callbackExampleCopy: '复制回调 cURL',
        callbackExampleCopied: '已复制回调示例',
        callbackDebugTitle: '回调自检面板',
        callbackDebugHint: '这里可以按你的渠道 code 与订单号动态生成回调请求，方便在测试环境或终端里验证回调链路。',
        callbackDebugProvider: '渠道路径',
        callbackDebugProviderPlaceholder: '例如 alipay',
        callbackDebugProviderHint: '留空时会优先使用上方已启用的第一个支付渠道。',
        manualCompleteOrderId: '订单 ID',
        manualCompleteOrderIdPlaceholder: '例如 9527',
        manualCompleteOrderIdHint: '管理员兜底完单接口必须传订单 ID。',
        callbackDebugOrderNo: '订单号',
        callbackDebugOrderNoPlaceholder: '例如 CO20260319000123',
        callbackDebugTradeNo: '渠道交易号',
        callbackDebugTradeNoPlaceholder: '例如 ALI20260319008888',
        callbackDebugAmount: '支付金额',
        callbackDebugCurrency: '支付币种',
        callbackDebugEndpoint: '解析后的回调地址',
        callbackDebugEndpointHint: '这是支付系统在支付成功后应该回调的公开地址。',
        callbackDebugPayload: '回调 Payload',
        callbackDebugPayloadHint: '发送前先确认 JSON 请求体内容。',
        callbackDebugPayloadCopy: '复制 Payload JSON',
        callbackDebugPayloadCopied: '已复制回调 Payload',
        callbackDebugCurl: '调试 cURL',
        callbackDebugCurlHint: '替换共享密钥后，可直接在测试环境或本地终端发起请求。',
        callbackDebugCurlCopy: '复制调试 cURL',
        callbackDebugCurlCopied: '已复制调试 cURL',
        callbackDebugLookupAction: '查询订单',
        callbackDebugLookupLoading: '查询中...',
        callbackDebugLookupHint: '按订单号查询后台订单，并自动回填订单 ID、金额、币种和支付渠道。',
        callbackDebugLookupResult: '匹配到的订单',
        callbackDebugLookupResultHint: '该结果会用于自动回填回调调试表单和手动完单表单。',
        callbackDebugLookupResultEmpty: '当前还没有匹配到订单。',
        callbackDebugLookupFieldOrderId: '订单 ID',
        callbackDebugLookupFieldProduct: '商品',
        callbackDebugLookupFieldUser: '用户 ID',
        callbackDebugLookupFieldStatus: '状态',
        callbackDebugLookupFieldAmount: '金额',
        callbackDebugLookupFieldProvider: '支付渠道',
        callbackDebugLookupFieldOrderNo: '订单号',
        callbackDebugLookupOrderNoRequired: '请先输入订单号',
        callbackDebugLookupEmpty: '未找到订单号为 {orderNo} 的订单',
        callbackDebugLookupSuccess: '已找到订单 {orderNo}',
        callbackDebugOpenOrdersAction: '打开订单列表',
        manualCompleteTitle: '模拟手动完单',
        manualCompleteHint: '仅管理员可用的兜底工具。它会直接调用手动完单接口，并可能立即发放余额、订阅或分组权益。',
        manualCompleteAction: '模拟完单',
        manualCompleteSubmitting: '完单中...',
        manualCompletePayload: '手动完单 Payload',
        manualCompletePayloadHint: '这就是发给管理员手动完单接口的请求体。',
        manualCompletePayloadCopy: '复制完单 Payload',
        manualCompletePayloadCopied: '已复制手动完单 Payload',
        manualCompleteResult: '手动完单结果',
        manualCompleteResultHint: '这里展示管理员手动完单接口最近一次返回结果。',
        manualCompleteResultCopy: '复制结果 JSON',
        manualCompleteResultCopied: '已复制手动完单结果',
        manualCompleteResultEmpty: '当前还没有可复制的手动完单结果',
        manualCompleteResultEmptyState: '尚未发起手动完单请求。',
        manualCompleteOrderIdRequired: '请输入有效的订单 ID',
        manualCompleteConfirm: '确定要对订单 #{orderId} 执行模拟手动完单吗？',
        manualCompleteSuccess: '订单 {orderNo} 已完成',
  ...
  marketplace: {
    loadFailed: '加载模型广场失败',
    emptyTitle: '暂未发布可购买商品',
    emptyDesc: '原生模型广场已启用，但尚未配置有效的模型展示或商品。',
    modelsSectionTitle: '模型广场',
    modelsSectionDesc: '按模型场景查看对应的套餐、购买方案和充值商品。',
    standaloneSectionTitle: '独立商品',
    standaloneSectionDesc: '这些商品可以不依赖某个模型展示单独售卖。',
    paymentMethodsTitle: '支付方式',
    paymentMethodsDesc: '这里展示管理员已配置的在线支付渠道。',
    prices: '价格',
    entitlements: '权益',
    vendor: '厂商',
    vendorUnknown: '未标注厂商',
    recommended: '推荐',
    noActiveOffers: '当前模型暂未绑定有效售卖方案。',
    daysSuffix: '天',
    title: '模型广场',
    description: '查看原生商业化入口与后续商品化模块',
    badge: 'Commerce Phase 1',
    heroTitle: '原生模型广场底座已启用',
    heroDescription: '当前版本已切入原生商业化入口模式，后续会在这里接入模型商品、充值、订单和权益发放能力。',
    viewSubscriptions: '查看我的订阅',
    viewOrders: '查看订单',
    viewWallet: '查看钱包',
    phaseOneTitle: '当前阶段',
    phaseOneDesc: '这一阶段先完成模式切换、可升级设置结构和站内入口，商品、钱包、订单能力会在后续迭代中逐步接入。',
    openLegacyPurchase: '打开旧版充值入口',
    createOrder: '创建订单',
    creatingOrder: '创建中...',
    orderCreated: '订单 {orderNo} 创建成功',
    orderCreateFailed: '创建订单失败',
    comingSoon: '该模块已预留入口，后续版本开放',
    notEnabledTitle: '原生模型广场未开启',
    notEnabledDesc: '管理员尚未启用原生模型广场模式，请联系管理员或使用旧版充值入口。',
    summary: {
      models: '模型数量',
      products: '商品数量',
      modules: '已启用模块'
    ...
    cards: {
      models: {
        title: '模型商品入口',
        desc: '后续会在这里承载模型广场、套餐和购买逻辑'
      },
      wallet: {
        title: '钱包与充值',
        desc: '原生钱包入口已启用，后续将接入余额流水与充值能力'
      },
      orders: {
        title: '订单与记录',
        desc: '原生订单入口已启用，后续将接入购买历史与支付状态'
      }
    }
  },
  ...
  orders: {
    title: '订单',
    description: '查看原生模型广场购买记录与发放状态',
    notEnabledTitle: '原生订单未开启',
    notEnabledDesc: '管理员尚未启用原生订单页面。',
    loadFailed: '加载订单失败',
    emptyTitle: '暂无订单',
    emptyDesc: '从原生模型广场创建的订单会出现在这里。',
    goMarketplace: '返回模型广场',
    orderNo: '订单号',
    price: '价格',
    createdAt: '创建时间',
    paidAt: '支付时间',
  ...
  wallet: {
    title: '钱包',
    description: '查看充值记录与原生钱包流水变化',
    notEnabledTitle: '原生钱包未开启',
    notEnabledDesc: '管理员尚未启用原生钱包页面。',
    loadFailed: '加载钱包流水失败',
    emptyTitle: '暂无钱包记录',
    emptyDesc: '由原生商业订单产生的余额变化会出现在这里。',
    goMarketplace: '返回模型广场',
    balanceBefore: '变更前余额',
    balanceAfter: '变更后余额',
    reason: '原因',
