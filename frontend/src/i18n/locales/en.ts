export default {
  ...
  admin: {
    ...
    commerce: {
      title: 'Commerce',
      description: 'Manage native marketplace products and model listings',
      summary: {
        recommended: 'Recommended'
      },
      actions: {
      ...
      hints: {
        tags: 'Separate tags with commas or new lines',
        metadata: 'JSON object only. Leave empty for {}',
        noProductsForBinding: 'Create a product first before binding it to a model'
      },
      ordersFilterPlaceholder: 'e.g. CO20260319000123',
      ordersFilterHint: 'Use an order number to quickly locate a checkout, callback, or manual-complete record.',
      ordersFilterActive: 'Filtering orders by order number: {orderNo}',
      orderDetailTitle: 'Order Details',
      orderDetailBasicInfo: 'Order Info',
      orderDetailSnapshot: 'Snapshot Details',
      orderDetailPaymentAction: 'Payment Action',
      orderDetailPaymentStatus: 'Payment Status',
      orderDetailPaidAt: 'Paid At',
      orderDetailExpiredAt: 'Expired At',
      orderDetailUpdatedAt: 'Updated At',
      orderDetailProductCode: 'Product Code',
      orderDetailPriceType: 'Price Type',
      orderDetailOriginalAmount: 'Original Amount',
      orderDetailMetadata: 'Metadata',
      orderDetailCheckoutUrl: 'Checkout URL',
      orderDetailPaymentActionEmpty: 'No payment action is available for this order.',
      orderDetailTransaction: 'Payment Transaction',
      orderDetailTransactionStatus: 'Transaction Status',
      orderDetailProviderTradeNo: 'Provider Trade No.',
      orderDetailPaidAmount: 'Paid Amount',
      orderDetailRequestPayload: 'Request Payload',
      orderDetailCallbackPayload: 'Callback Payload',
      orderDetailTransactionEmpty: 'No payment transaction is available for this order.',
      statuses: {
        draft: 'Draft',
        active: 'Active',
        disabled: 'Disabled'
      ...
      empty: {
        ...
        productsDesc: 'Create the first purchasable product for the native marketplace.',
        modelsTitle: 'No model listings yet',
        modelsDesc: 'Create the first model listing and bind products to it.',
        pricesDesc: 'No price rows yet. Add at least one pricing option when needed.',
        grantsDesc: 'No entitlement rows yet. Add group access or subscription grants here.',
        bindingsDesc: 'No product bindings yet. Bind one or more products to this model.'
      },
      messages: {
        loadFailed: 'Failed to load commerce catalog',
        productCreated: 'Product created successfully',
        productUpdated: 'Product updated successfully',
        modelCreated: 'Model listing created successfully',
        modelUpdated: 'Model listing updated successfully',
        orderCompleted: 'Order completed successfully',
        manualCompleteConfirm: 'Manually complete order {orderNo}?'
      },
      validation: {
        ...
        metadataObjectOnly: 'Metadata must be a JSON object',
        priceTypeRequired: 'Price row #{index} requires a price type',
        priceAmountRequired: 'Price row #{index} requires an amount',
        currencyRequired: 'Price row #{index} requires a currency',
        groupRequired: 'Entitlement row #{index} requires a group',
        productRequired: 'Binding row #{index} requires a product'
      }
    },
    ...
    settings: {
      ...
      purchase: {
        ...
        description: 'Control the commerce entry and switch between iframe mode and native marketplace mode',
        enabled: 'Show Recharge / Subscription Entry',
        enabledHint: 'Only shown in standard mode (not simple mode)',
        mode: 'Entry Mode',
        modeHint: 'iframe mode keeps the external payment page; native mode uses the built-in marketplace as the main entry',
        modeOptionsIframe: 'iframe external mode',
        modeOptionsNative: 'native marketplace mode',
        url: 'Recharge / Subscription URL',
        urlPlaceholder: 'https://example.com/purchase',
        urlHint: 'Must be an absolute http(s) URL',
        urlHintOptional: 'Optional in native mode; can be kept as a legacy fallback link',
        iframeWarning:
        ...
        nativeMarketplaceEnabled: 'Enable native marketplace',
        nativeMarketplaceHint: 'When enabled, the primary sidebar entry switches to the built-in marketplace page',
        nativeWalletEnabled: 'Enable native wallet page',
        nativeWalletHint: 'Reserves a switch for future balance ledger and recharge pages',
        nativeOrdersEnabled: 'Enable native orders page',
        nativeOrdersHint: 'Reserves a switch for future order history and payment status pages',
        callbackSecret: 'Callback Shared Secret',
        callbackSecretPlaceholder: 'Set a shared secret for payment callbacks',
        callbackSecretConfiguredPlaceholder: 'Leave blank to keep current secret',
        callbackSecretHint: 'Used to verify public payment callbacks before auto-completing native commerce orders',
        callbackSecretConfiguredHint: 'A callback secret is already stored. Leave blank to keep it unchanged',
        callbackEndpoint: 'Callback Endpoint',
        callbackEndpointHint:
          'Provider-agnostic success callback. Send order_no, and optionally provider_trade_no, paid_amount, paid_currency, request_payload, and callback_payload',
        callbackHeader: 'Required Header',
        callbackHeaderHint: 'Send the configured shared secret in this header on every callback request',
        providersTitle: 'Payment Provider Configuration',
        providersHint: 'Configure display metadata and checkout URL templates for each enabled provider.',
        providersEmpty: 'No payment providers configured yet. Add one to expose online checkout buttons in the native marketplace.',
        providerCard: 'Provider',
        providerAdd: 'Add Provider',
        providerRemove: 'Remove Provider',
        providerCode: 'Provider Code',
        providerCodeHint: 'Unique identifier used by the order and callback flow',
        providerCodePlaceholder: 'e.g. alipay, wechat_pay, stripe',
        providerName: 'Provider Name',
        providerNamePlaceholder: 'e.g. Alipay',
        providerDescription: 'Provider Description',
        providerDescriptionPlaceholder: 'Short description shown to users in the marketplace',
        providerIcon: 'Provider Icon URL',
        providerIconPlaceholder: 'https://example.com/icon.png',
        providerSortOrder: 'Sort Order',
        providerCheckoutUrl: 'Checkout URL Template',
        providerCheckoutUrlPlaceholder: 'https://pay.example.com/checkout?order_no={order_no}',
        providerEnabled: 'Enable Provider',
        providerEnabledHint: 'Only enabled providers are exposed in the native marketplace',
        providerTemplateHint: 'Supports variable placeholders so the checkout link is generated per order.',
        providerTemplateVars: 'Available template variables',
        providerExampleTitle: 'Provider JSON Example',
        providerExampleHint: 'Sample `commerce_payment_providers` JSON. Replace domains, names, and templates before saving.',
        providerExampleCopy: 'Copy Example JSON',
        providerExampleCopied: 'Provider example JSON copied',
        callbackExampleTitle: 'Callback Test Example',
        callbackExampleHint: 'Use this curl example in staging. Replace the provider path, secret, and pending order number before sending.',
        callbackExampleCopy: 'Copy Callback cURL',
        callbackExampleCopied: 'Callback example copied',
        callbackDebugTitle: 'Callback Debug Panel',
        callbackDebugHint: 'Build a provider callback request with your own provider code and order number before sending it from staging tools or terminal.',
        callbackDebugProvider: 'Provider Path',
        callbackDebugProviderPlaceholder: 'e.g. alipay',
        callbackDebugProviderHint: 'Leave blank to use the first enabled provider from the configuration above.',
        manualCompleteOrderId: 'Order ID',
        manualCompleteOrderIdPlaceholder: 'e.g. 9527',
        manualCompleteOrderIdHint: 'Required for the admin fallback completion API.',
        callbackDebugOrderNo: 'Order No.',
        callbackDebugOrderNoPlaceholder: 'e.g. CO20260319000123',
        callbackDebugTradeNo: 'Provider Trade No.',
        callbackDebugTradeNoPlaceholder: 'e.g. ALI20260319008888',
        callbackDebugAmount: 'Paid Amount',
        callbackDebugCurrency: 'Paid Currency',
        callbackDebugEndpoint: 'Resolved Callback Endpoint',
        callbackDebugEndpointHint: 'This is the public callback URL that your payment system should call after successful payment.',
        callbackDebugPayload: 'Callback Payload',
        callbackDebugPayloadHint: 'Preview JSON body before sending the callback.',
        callbackDebugPayloadCopy: 'Copy Payload JSON',
        callbackDebugPayloadCopied: 'Callback payload copied',
        callbackDebugCurl: 'Debug cURL',
        callbackDebugCurlHint: 'Send this request from your staging environment or local terminal after replacing the shared secret.',
        callbackDebugCurlCopy: 'Copy Debug cURL',
        callbackDebugCurlCopied: 'Callback debug cURL copied',
        callbackDebugLookupAction: 'Lookup Order',
        callbackDebugLookupLoading: 'Looking up...',
        callbackDebugLookupHint: 'Fetch the admin order by order number and autofill order ID, amount, currency, and provider.',
        callbackDebugLookupResult: 'Matched Order',
        callbackDebugLookupResultHint: 'This lookup result is used to autofill the debug and manual-complete forms.',
        callbackDebugLookupResultEmpty: 'No order has been matched yet.',
        callbackDebugLookupFieldOrderId: 'Order ID',
        callbackDebugLookupFieldProduct: 'Product',
        callbackDebugLookupFieldUser: 'User ID',
        callbackDebugLookupFieldStatus: 'Status',
        callbackDebugLookupFieldAmount: 'Amount',
        callbackDebugLookupFieldProvider: 'Provider',
        callbackDebugLookupFieldOrderNo: 'Order No.',
        callbackDebugLookupOrderNoRequired: 'Please enter an order number first',
        callbackDebugLookupEmpty: 'No order found for {orderNo}',
        callbackDebugLookupSuccess: 'Order {orderNo} found',
        callbackDebugOpenOrdersAction: 'Open Order List',
        manualCompleteTitle: 'Simulate Manual Completion',
        manualCompleteHint: 'Admin-only fallback tool. This directly calls the manual completion API and may deliver wallet, subscription, or group entitlements.',
        manualCompleteAction: 'Simulate Complete',
        manualCompleteSubmitting: 'Completing...',
        manualCompletePayload: 'Manual Complete Payload',
        manualCompletePayloadHint: 'This request body is sent to the admin manual-complete endpoint.',
        manualCompletePayloadCopy: 'Copy Manual Payload',
        manualCompletePayloadCopied: 'Manual-complete payload copied',
        manualCompleteResult: 'Manual Complete Result',
        manualCompleteResultHint: 'The latest response returned by the admin manual-complete endpoint.',
        manualCompleteResultCopy: 'Copy Result JSON',
        manualCompleteResultCopied: 'Manual-complete result copied',
        manualCompleteResultEmpty: 'No manual-complete result to copy yet',
        manualCompleteResultEmptyState: 'No manual-complete request has been sent yet.',
        manualCompleteOrderIdRequired: 'Please enter a valid order ID',
        manualCompleteConfirm: 'Simulate manual completion for order #{orderId}?',
        manualCompleteSuccess: 'Order {orderNo} completed successfully',
  ...
  marketplace: {
    title: 'Marketplace',
    description: 'Review the native commerce entry and upcoming monetization modules',
    badge: 'Commerce Phase 1',
    heroTitle: 'Native marketplace foundation is now enabled',
    heroDescription: 'This phase wires the native commerce entry mode. Model products, top-ups, orders, and entitlement delivery will be added here in later iterations.',
    viewSubscriptions: 'View my subscriptions',
    viewOrders: 'View orders',
    viewWallet: 'View wallet',
    loadFailed: 'Failed to load marketplace catalog',
    emptyTitle: 'No products have been published yet',
    emptyDesc: 'Native marketplace is enabled, but there are no active model listings or purchasable products yet.',
    modelsSectionTitle: 'Model Plaza',
    modelsSectionDesc: 'Browse model-aligned packages, plans, and top-up offers.',
    standaloneSectionTitle: 'Standalone Products',
    standaloneSectionDesc: 'These products are available independently from specific model listings.',
    paymentMethodsTitle: 'Payment Methods',
    paymentMethodsDesc: 'Available online checkout channels configured by the administrator.',
    prices: 'Prices',
    entitlements: 'Entitlements',
    vendor: 'Vendor',
    vendorUnknown: 'Vendor not specified',
    recommended: 'Recommended',
    noActiveOffers: 'No active offers are bound to this model yet.',
    daysSuffix: 'd',
    phaseOneTitle: 'Current phase',
    phaseOneDesc: 'This iteration focuses on mode switching, upgrade-safe settings, and the in-app entry point. Products, wallet, and order capabilities land in subsequent phases.',
    openLegacyPurchase: 'Open legacy purchase entry',
    createOrder: 'Create order',
    creatingOrder: 'Creating...',
    orderCreated: 'Order {orderNo} created successfully',
    orderCreateFailed: 'Failed to create order',
    comingSoon: 'This module is reserved for a later phase',
    notEnabledTitle: 'Native marketplace is not enabled',
    notEnabledDesc: 'The administrator has not enabled native marketplace mode yet. Please contact admin or use the legacy purchase entry.',
    summary: {
      models: 'Models',
      products: 'Products',
    ...
    productTypes: {
      ...
      subscriptionGroup: 'Subscription package',
      standardGroupAccess: 'Access package',
      combo: 'Combo package'
    },
    bindingTypes: {
    ...
    cards: {
      models: {
        title: 'Model product entry',
        desc: 'This page will later host the marketplace, plans, and purchase flow'
      },
      wallet: {
        title: 'Wallet and top-up',
        desc: 'The native wallet switch is enabled and will later power ledger and recharge flows'
      },
      orders: {
        title: 'Orders and history',
        desc: 'The native orders switch is enabled and will later power purchase history and payment status'
      }
    }
  },
  ...
  orders: {
    title: 'Orders',
    description: 'Review your native marketplace purchase history and delivery status',
    notEnabledTitle: 'Native orders are not enabled',
    notEnabledDesc: 'The administrator has not enabled the native orders page yet.',
    loadFailed: 'Failed to load orders',
    emptyTitle: 'No orders yet',
    emptyDesc: 'Orders created from the native marketplace will appear here.',
    goMarketplace: 'Back to marketplace',
    orderNo: 'Order No.',
    price: 'Price',
    createdAt: 'Created At',
    paidAt: 'Paid At',
  ...
  wallet: {
    title: 'Wallet',
    description: 'Review recharge records and native wallet ledger changes',
    notEnabledTitle: 'Native wallet is not enabled',
    notEnabledDesc: 'The administrator has not enabled the native wallet page yet.',
    loadFailed: 'Failed to load wallet ledger',
    emptyTitle: 'No wallet records yet',
    emptyDesc: 'Balance changes created by native commerce orders will appear here.',
    goMarketplace: 'Back to marketplace',
