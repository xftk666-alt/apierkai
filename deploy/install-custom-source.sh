...
DOCKER_IMAGE_PREFIX_VALUE="${DOCKER_IMAGE_PREFIX:-docker.m.daocloud.io/library}"
NODE_IMAGE_VALUE="${NODE_IMAGE:-${DOCKER_IMAGE_PREFIX_VALUE}/node:24-alpine}"
GOLANG_IMAGE_VALUE="${GOLANG_IMAGE:-${DOCKER_IMAGE_PREFIX_VALUE}/golang:1.26.1-alpine}"
ALPINE_IMAGE_VALUE="${ALPINE_IMAGE:-${DOCKER_IMAGE_PREFIX_VALUE}/alpine:3.21}"
POSTGRES_IMAGE_VALUE="${POSTGRES_IMAGE:-${DOCKER_IMAGE_PREFIX_VALUE}/postgres:18-alpine}"
REDIS_IMAGE_VALUE="${REDIS_IMAGE:-${DOCKER_IMAGE_PREFIX_VALUE}/redis:8-alpine}"
...
prepare_env_file() {
    ...
    upsert_env "DOCKER_IMAGE_PREFIX" "${DOCKER_IMAGE_PREFIX_VALUE}" "${env_file}"
    upsert_env "NODE_IMAGE" "${NODE_IMAGE_VALUE}" "${env_file}"
    upsert_env "GOLANG_IMAGE" "${GOLANG_IMAGE_VALUE}" "${env_file}"
    upsert_env "ALPINE_IMAGE" "${ALPINE_IMAGE_VALUE}" "${env_file}"
    upsert_env "POSTGRES_IMAGE" "${POSTGRES_IMAGE_VALUE}" "${env_file}"
    upsert_env "REDIS_IMAGE" "${REDIS_IMAGE_VALUE}" "${env_file}"
